document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFormSuccess(form) {
    const message = form.getAttribute('data-success-message') || 'Thank you! Your message has been sent.';
  ...
  // Re-observe dynamically added elements (optional MutationObserver)
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'aa95f703-47a1-4709-b391-1533a9c128d7',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'aa95f703-47a1-4709-b391-1533a9c128d7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'aa95f703-47a1-4709-b391-1533a9c128d7';
